...
> **Nota**
>
> Simular que realmente realizan dichas actividades con el conocimiento que tengan. El objetivo es practicar la comunicación y la sincronización.
...
- **Crear** nuevas tareas o subtareas si surgen de la reunión acciones concretas necesarias para resolver un bloqueo.

### Tarea 3. Construir los gráficos de progreso a mano
*En lugar de usar los reportes automáticos, se construirán gráficos propios para entender realmente qué miden.*
...
**Paso 2.** Dibujar el _Burndown Chart_.
- **Crear** un gráfico con dos ejes en una hoja de papel o en una pizarra digital.
    - **Eje _Y_ (vertical):** puntos de historia (desde 0 hasta el total comprometido).
    - **Eje _X_ (horizontal):** días del sprint (desde el día 1 hasta el 10).
- **Dibujar** la "línea ideal": una línea recta que va desde el total de puntos el día 0 hasta 0 puntos el último día.
- **Simular** el progreso diario: cada día, "quemar" (restar) los puntos de las historias que el equipo simula haber completado. **Marcar un punto en el gráfico** con el total de puntos restantes para cada día y unir los puntos para crear la "línea real".
- **Analizar:** ¿la línea real está por encima o por debajo de la línea ideal? ¿Qué significa eso para el progreso del sprint?

**Paso 3.** Dibujar el _Burnup Chart_.
...
- **Dibujar** la línea de progreso: cada día, **marcar un punto** que represente la suma total de puntos de las historias completadas hasta ese día. Unir los puntos.
- **Analizar:** ¿qué tan cerca está la línea de progreso de alcanzar la línea de alcance total? y ¿qué pasaría si el alcance aumentara a mitad del sprint?
